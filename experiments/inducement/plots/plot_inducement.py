...
def plot_main_exp():
    ...
    plot_certain_val_domain(
        ax=axs[0, 1],
        paths_to_csv=[
            "experiments/inducement/results/csv/major_sax_val6_induced_val_0823.csv",
            "experiments/inducement/results/csv/major_sax_val6_induced_all_0823.csv",
        ],
        val=6,
        domain="x",
    )
    ...
    plot_certain_val_domain(
        ax=axs[0, 0],
        paths_to_csv=[
            "experiments/inducement/results/csv/major_sax_val3_induced_val_0827.csv",
            "experiments/inducement/results/csv/major_sax_val3_induced_all_0827.csv",
        ],
        val=3,
        domain="x",
    )
...
def plot_interval_probing_exp():
    ...
    csv_files = [
        "experiments/inducement/results/csv/major_sav_val3_induced_probe_0914.csv",
        "experiments/inducement/results/csv/major_sav_val6_induced_probe_0914.csv",
    ]
    bar_labels = [
        "w/ symmetry (K=4)",
        "w/ symmetry (K=1)",
    ...
    plt.savefig("experiments/inducement/results/figures/interval_probing_plot.svg", transparent=True, dpi=500)
