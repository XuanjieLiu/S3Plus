...
for i in {0..4}; do
  python run_training.py \
    ...
    --name major_sax_transition_val6_symm0.2frombl_k24_normed_cos_gru_gr7_$i \
    --load_checkpoint "experiments/transition/logs/major_sax_transition_val6_nosymm_k24_normed_cos_gru_$i/cp_step3901.pt" \
    --data_dir "../data/sax_major_val_ood_spectrum_2/sax_major_val6" \
    --data_type 6 \
    --loss_config.weights.prior_loss 1 \
    --loss_config.weights.isymm_loss "min(0.2, t/2000)" \
