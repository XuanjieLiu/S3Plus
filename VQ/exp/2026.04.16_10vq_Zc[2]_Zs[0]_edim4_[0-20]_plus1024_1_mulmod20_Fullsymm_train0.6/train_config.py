...
EVAL_SET = f"{data_root}/single_style_pairs_mul_mod21(0,20)/test"
TRAIN_SET = f"{data_root}/single_style_pairs_mul_mod21(0,20)/train"
SINGLE_IMG_SET = f"{data_root}/(0,20)-FixedPos-oneStyle"
IS_BLUR = False
AUGMENT_TIMES = 1
CONFIG = {
    'train_data_path': [TRAIN_SET, EVAL_SET],
