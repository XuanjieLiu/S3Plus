...
CONFIG = {
    'train_data_path': f"{data_root}/single_style_plus_random_one_shot_triple_set(1,20)_arabic/train",
    'single_img_eval_set_path': f"{data_root}/(1,20)-FixedPos-oneStyle_arabic",
    'plus_eval_set_path': f"{data_root}/single_style_plus_random_one_shot_triple_set(1,20)_arabic/test_1",
    'plus_eval_set_path_2': f"{data_root}/single_style_plus_random_one_shot_triple_set(1,20)_arabic/test_2",
