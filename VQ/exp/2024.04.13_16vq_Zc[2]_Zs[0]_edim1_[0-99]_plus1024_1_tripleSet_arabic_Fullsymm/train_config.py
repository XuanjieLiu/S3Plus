...
CONFIG = {
    'train_data_path': f"{data_root}/single_style_pairs(0,99)_arabic/train",
    'single_img_eval_set_path': f"{data_root}/(0,99)-FixedPos-oneStyle_arabic",
    'plus_eval_set_path': f"{data_root}/single_style_pairs(0,99)_arabic/test",
