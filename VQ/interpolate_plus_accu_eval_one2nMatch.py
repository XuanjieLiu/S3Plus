"""
This script evaluates the accuracy of interpolated plus operations in a VQ-VAE model.
It generates interpolated numbers, creates pairs for evaluation, and computes the accuracy of the model's
Different from interpolate_plus_accu_eval.py, this script allows for evaluation accuracy of one-to-n match.
"""
...
from eval_plus_nd import mode_emb_label_dict
