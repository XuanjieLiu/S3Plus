...
def collect_from_dataset(
    data_dir,
    save_dir,
    ins_list=[64, 19, 21, 41, 56, 59, 68, 71, 72, 75, 22, 52],
    normalize_note_duration=True,
    only_one_octave=True,
    transpose=False,
    portion=0.02,
):
    """
        ...
        if len(midi_data.instruments) > 1:
            ...
            if not transpose:
                ...
                for i in range(-5, 7):
                    ...
                    midi_data_transposed.write(
                        os.path.join(save_dir, file_name_transposed)
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default="../../mucodec/data/Wikifonia_midi"
    )
