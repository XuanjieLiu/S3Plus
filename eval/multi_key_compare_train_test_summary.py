...
eg1 = ExpGroup(
    exp_name="2023.06.27_5vq_Zc[2]_Zs[0]_edim1_plus0.02_switch1dig_assocIn_[0-20]",
    exp_alias='w/ associative loss',
...
eg2 = ExpGroup(
    exp_name="2023.06.27_5vq_Zc[2]_Zs[0]_edim1_plus0.02_switch1dig_assocIn_[0-20]_noAssoc",
    exp_alias='w/o associative loss',
    sub_exp=[i for i in range(1, 21)],
    record_name="plus_eval.txt",
)
